...
public class FunktionGruppeBeitreten implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == GruppeBeitreten.loeschen) {
			MeinProfil.gruppenListe.remove(GruppeBeitreten.gruppen.getItemAt(GruppeBeitreten.gruppen.getSelectedIndex()));
		}
	...
	public void gruppenLaden() {
		GruppeBeitreten.gruppenListe.add("Gruppe1");
		GruppeBeitreten.gruppenListe.add("Gruppe2");
		GruppeBeitreten.gruppenListe.add("Gruppe3");
	}
